...
<?php if ($ProfileData[0]["user_fbid"] >=1) {  ?>
      <a target="_blank" href="http://www.facebook.com/profile.php?id=<?=$ProfileData[0]["user_fbid"]?>"><img src="<?=$website?>img/facebook_icon.png" alt="" class="imgvalign" /></a>
<?php } ?>
	  </td>
	</tr>
    ...
    <tr>
	  ...
	  <td><?=ShowUserAvatar(trim($ProfileData[0]["user_avatar"]), 64, 64, "", $lang["remove_avatar"]);?>
	  <?=UploadAvatar($AllowUploadAvatar, $ProfileData[0]["user_avatar"] ) ?></td>
	</tr>
