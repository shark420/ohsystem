...
if ($PlayDotaHeroes == 1) {
  if (file_exists( "cache/pdheroes/".$pdHero.".html" ) )
  include( "cache/pdheroes/".$pdHero.".html" );
} else {
...
<table>
  <tr>
   <td width="100" class="padLeft"><img class="imgvalign" src="<?=$website?>img/heroes/<?=$Hero["original"]?>.gif" alt="" /></td>
   <td><h2><?=$Hero["description"]?></h2></td>
  </tr>
</table>
