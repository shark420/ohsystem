...
if (!isset($website) ) { header('HTTP/1.1 404 Not Found'); die; }
  ...
  <table class="Table500px">
    ...
    <tr class="row">
	  ...
	  <td width="60"><b><?=$lang["win_percent"] ?>:</b></td>
    ...
    <tr class="row">
	  ...
	  <td width="60"><b><?=$lang["assists"]?>:</b></td>
    ...
    <tr class="row">
	  ...
	  <td width="60"><b><?=$lang["towers"]?>:</b></td>
    ...
    <tr class="row">
	  ...
	  <td width="60"><b><?=$lang["rax"]?>:</b></td>
	  <td width="160"><?=($User["rax"])?></td>
	</tr>
	
    <tr class="row">
	  <td class="padLeft" width="140"><b><?=$lang["kpm"]?>:</b></td>
	  <td width="160"><?=$User["kpm"]?></td>
	  <td width="60"><b><?=$lang["dpm"]?>:</b></td>
...
<tr>
  ...
  <a href="<?=$website?>?ban_report&amp;user=<?=$User["player"]?>"><?=$lang["report_user"]?></a>
  </div>
  <?php }
