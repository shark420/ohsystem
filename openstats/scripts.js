...
var segment_1 = pathArray[pathArray.length-2];

if (segment_1 == 'adm') arrowpath = '../'; else arrowpath = '';

document.write('<div id="dhtmltooltip"></div>') //write out tooltip DIV
document.write('<img id="dhtmlpointer" src="'+arrowpath+'img/arrow.gif">') //write out pointer image
